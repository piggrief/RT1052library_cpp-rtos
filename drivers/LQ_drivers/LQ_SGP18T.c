...
其他说明：无
**********************************************************/
#define TFTSPI_CS     PT2_25    //CS   A13
#define TFTSPI_SCL    PT2_12    //SCL  C10
#define TFTSPI_SDA    PT2_14    //SDI  E10
#define TFTSPI_DC     PT2_24    //DC   A12
#define TFTSPI_RST    PT3_26    //RST  A7
...
{ 	
  ...
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_12_GPIO2_IO12, 0x10B0u);
  IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_14_GPIO2_IO14, 0x10B0u);
  ...
  GPIO_PinInit(GPIO2, 25, &GPIO_Output_Config);      // CS   D12
  GPIO_PinInit(GPIO2, 12, &GPIO_Output_Config);      // SCL  E12
  GPIO_PinInit(GPIO2, 14, &GPIO_Output_Config);      // SDI  B13
  GPIO_PinInit(GPIO2, 24, &GPIO_Output_Config);      // DC   E11 
  GPIO_PinInit(GPIO3, 26, &GPIO_Output_Config);      // RST  D11
